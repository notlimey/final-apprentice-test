...
const RegisterView = () => {
	...
	return (
		<div className='min-h-screen flex items-center justify-center'>
			<Card className='px-8 py-8 rounded-lg max-w-2xl mx-auto w-full'>
				<CardHeader>
									...
									render={({ field }) => (
										<FormItem className='flex flex-row items-center justify-between rounded-lg border p-4'>
											<div className='space-y-0.5'>
												...
												<FormDescription>
													Hvis du ønsker å være anonym, kan du velge å ikke vise navnet ditt
													på siden. Brukernavn vil være det eneste som vises.
												</FormDescription>
											</div>
											<FormControl>
